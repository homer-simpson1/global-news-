...
export const FOREIGN_ENTITIES = {
  ...
  EUROPE_ECB: /欧洲央行|欧央行|拉加德|ecb|欧元区.*通胀|德债|bund|法债|oat|意债|欧洲.*基准利率|欧洲.*降息|欧洲.*加息/i,
  UK_BOE: /英国央行|英央行|贝利|boe|英格兰银行|英镑|英国国债|英债|gilt/i,
  // 涵盖美国全境主权、政法、法院、能源与州级实体（绝对禁止进入国内板块，排除国内媒体‘华尔街见闻’）
  US_ALL: /(?:美国|美方|特朗普|拜登|哈里斯|美联储|沃什|凯文·沃什|warsh|鲍威尔|耶伦|美债|美国国债|美国财政部|美国司法部|美国能源部|美国商务部|美国交通部|美国国务院|五角大楼|美国法院|巡回法院|联邦巡回|上诉法院|最高法院|美国法官|(?<!见)华尔街(?!见闻)|纳斯达克|道琼斯|标普500|非农|初请|失业金|美股三大|fomc|白宫|众议院|参议院|国会山|密歇根|加利福尼亚|加州|得克萨斯|得州|德州|佛罗里达|伊利诺伊|明尼苏达|俄亥俄|宾夕法尼亚|哥伦比亚特区|华盛顿特区|联邦电力法|环境保护署|epa)/i,
  US_MACRO: /美联储|沃什|凯文·沃什|warsh|鲍威尔|美债|美国国债|耶伦|美国财政部|(?<!见)华尔街(?!见闻)|纳斯达克|道琼斯|标普500|非农|初请|失业金|美股三大|fomc|(?:白宫|美国总统).*(?:预算|法案|关税|财政|赤字|行政令|经济顾问|债务上限|贸易|制裁|通胀|芯片)/i,
  WAR_DEFENSE: /五角大楼|防卫省|以军|俄军|乌军|克里姆林宫|北约|泽连斯基|普京|内塔尼亚胡|哈马斯|真主党|黎巴嫩|加沙|也门|胡塞|霍尔木兹|伊朗|卡塔尔|波斯湾|红海|叙利亚|伊拉克|前线交火|空袭|停火协议|军费|军工出口|防务演习/i,
...
// 2.1 中国国内金融机构、券商、交易所与市场主体（绝对禁止进入 us_macro）
export const DOMESTIC_SECURITIES_FINANCE =
  /(?:券商|证券|中信证券|中金公司|招商证券|广发证券|国泰君安|海通证券|申万宏源|银河证券|华泰证券|东兴证券|方正证券|浙商证券|光大证券|国信证券|兴业证券|中银证券|中加基金|证监会|中基协|上交所|深交所|北交所|公募|私募|基金公司|理财子公司|两市|沪深|a股|港股|恒生|南向资金|北向资金|中概股)/i;
