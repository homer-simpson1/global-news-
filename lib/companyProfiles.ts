...
export const CURATED_COMPANY_PROFILES: CompanyProfile[] = [
  ...
  {
    name: '西藏宁算科技',
    aliases: ['宁算科技', '西藏宁算', '宁算'],
    sector: '绿色智算 / 高原超算中心',
    description: '国内聚焦高原清洁能源智算中心建设运营主体，曾规划西藏大型算力网络基础设施，后因债务纠纷与关联担保风险陷入破产重整程序。',
    marketRole: '区域性绿色算力基建参与方，面临司法化解存量债务与核心算力资产盘活。',
    coreProducts: ['拉萨绿色数据中心', '云算力租赁网络'],
  },
  {
    name: '信威集团',
    aliases: ['信威集团', '北京信威', '信威通信', '信威'],
    sector: '通信设备 / 资本重组风险出清',
    description: '曾为A股千亿市值通信概念股，因巨额海外债务隐匿与财务造假于2021年退市，实控人王靖引发的跨国基建与金融担保风险持续出清。',
    marketRole: '资本市场重大财务退市主体，其历史衍生担保与债务诉讼持续牵连相关资产。',
    coreProducts: ['McWiLL专网通信', '海外通信运营'],
  },
