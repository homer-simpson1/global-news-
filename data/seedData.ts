...
export const SEED_FLASH_BRIEFS: FlashBrief[] = [
  {
    ...
    transmission: "一级交易商与货币市场基金维持高息收益底座，高杠杆中小企业承担利息支出压力，配置型资金自高估值成长资产流向短久期国债。",
    impactLevel: 1,
    time: "9月9日 09:45",
    ...
    summaryParagraph: "据9月9日 09:45（权威电讯核验发布）消息，美联储货币政策追踪委员会及华尔街一级交易商在华盛顿与纽约金融中心传来实质动态：美国2年期国债收益率在非农数据发布后走高2.9个基点至4.37%，市场迅速削减年内激进降息押注。深层动因在于劳动力市场表现稳健打破了宽松预期，短久期国债抛压集中涌现，直接重估全市场借贷成本底座。",
    summary5W1H: {
  ...
  },
  {
    ...
    summaryParagraph: "据9月9日 09:30（行业追踪快报）消息，台积电先进制程晶圆代工部门与英伟达供应链主管在亚太半导体核心三角传来实质动态：3nm及下一代2nm先进制程晶圆代工产能利用率连续两季度达到满负荷极限，主要算力原厂排单周期已延展至2026年第二季度，代工综合单价上浮15%。深层动因在于北美超大规模云厂商不计成本争抢先进制程，巩固了代工龙头的卖方市场地位。",
    summary5W1H: {
  ...
  },
  {
    ...
    summaryParagraph: "据9月9日 10:15（大宗市场权威追踪）消息，全球主流班轮公司与大宗商品交易商在欧洲鹿特丹港与红海航道传来实质动态：集装箱海运欧线即期运价在红海绕航常态化下大幅跳升，伦铜显性库存降至近三年低位。深层动因在于船舶绕行非洲好望角导致单程拉长两周，物理性吃掉了全球一成运力，船东议价权完全主导市场。",
    summary5W1H: {
  ...
  },
  {
    ...
    summaryParagraph: "据9月9日 08:54（军情核验播报）消息，美国国防部（五角大楼）反间谍部门在华盛顿总部及各战区联合作战司令部传来实质动态：五角大楼对美军战略武器库存与战备调配涉密数据外泄展开刑事调查，要求数十名关键指挥军官接受多导测谎。深层动因在于前沿防务战备技术底牌遭未授权外泄触及安全红线，导致五角大楼紧急冻结外部准入权限并彻查军工外包商。",
    summary5W1H: {
  ...
  },
  {
    ...
    summaryParagraph: "据9月9日 15:20（司法权威通报）消息，中国证监会原副主席王建军受贿案在山东省青岛市中级人民法院一审公开宣判，认定受贿金额高达9340万元，依法判处无期徒刑并剥夺政治权利终身。深层动因在于国家以零容忍态度穿透式打击金融监管腐败，清算滥用审批特权谋取私利的违法行径，重塑证券发行与监管红线。",
    summary5W1H: {
  ...
  },
  {
    ...
    summaryParagraph: "据9月9日 09:22（电讯直报）消息，乌拉圭农牧渔业部与国家卫生防疫局在南美主要农牧产区传来实质动态：乌拉圭境内多处农场发现高致病性禽流感，政府签署紧急法令宣布全境进入卫生紧急状态。深层动因在于阻断候鸟迁徙引发的病毒向周边巴西养殖带渗透，邻国海关已紧急提升肉类检疫隔离等级，波及南美大宗农牧产品跨境出口。",
    summary5W1H: {
