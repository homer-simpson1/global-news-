...
export const SEED_FLASH_BRIEFS: FlashBrief[] = [
  {
    ...
    sentiment: "BEARISH",
    nextWatchlist: "【后续观察哨】：锁定在 9月25日 20:30 美国 8 月 CPI 数据公布及 9 月 FOMC 议息决议降息幅度。",
    bullBearDivergence: {
      bullConsensus: "非农就业保持韧性验证美国经济软着陆路径，企业盈利基本面仍有坚实支撑。",
      bearDivergence: "紧缩周期尾声利率居高难下，若通胀反复可能推迟降息窗口，压制高估值科技资产。"
    },
    summaryParagraph: "据9月23日 09:45彭博全球宏观报道，美国2年期国债收益率在非农数据发布后走高2.9个基点至4.37%。信源表明，该事项起因于8月非农新增就业保持稳健抑制了美联储急迫降息预期。直接影响方面，重塑全市场借贷成本底座。",
    summary5W1H: {
      who: "美联储货币政策追踪委员会与华尔街一级交易商",
      what: "美国2年期国债收益率在非农数据发布后走高2.9个基点至4.37%，交易员削减激进降息押注。",
      when: "9月23日 09:45（权威电讯核验发布）",
  ...
  },
  {
    ...
    summaryParagraph: "据9月23日 09:30日经亚洲报道，台积电3nm及下一代2nm先进制程晶圆代工产能利用率达满负荷极限，代工综合单价传上浮15%。信源表明，该事项起因于北美头部云厂商密集采购生成式AI算力芯片。直接影响方面，推升次世代AI服务器整机物料成本。",
    summary5W1H: {
      who: "台积电先进制程业务部、英伟达及全球云服务超大规模算力采购商",
      what: "先进制程晶圆代工产能全线告急且代工综合单价上浮15%，主要算力芯片排单周期延至2026年中。",
      when: "9月23日 09:30（行业追踪快报）",
  ...
  },
  {
    ...
    summaryParagraph: "据9月23日 10:15标普全球商品报道，商船绕行非洲好望角使亚欧航线单程航期延长约两周，欧线集装箱海运即期运价维持高位。信源表明，该事项起因于红海地缘风险致使船舶改道消耗可用运力。直接影响方面，跨国进出口企业承担周转周期拉长与运费上涨成本。",
    summary5W1H: {
      who: "马士基、达飞等全球班轮巨头与大宗商品现货交易商",
      what: "红海商船绕行好望角常态化，欧线集装箱海运即期运价持续大涨，可用运力吃紧。",
      when: "9月23日 10:15（大宗市场权威追踪）",
  ...
  },
  {
    ...
    summaryParagraph: "据9月23日 08:54五角大楼官方通报，美防务机构就敏感战备库存与装备数据外泄启动反间谍调查，多名指挥军官接受技术测谎。信源表明，该事项起因于关键涉密战备技术存在未授权外流隐患。直接影响方面，外部防务外包与人员准入审查全面收紧。",
    summary5W1H: {
      who: "美国国防部（五角大楼）、联邦调查局（FBI）反间谍部门及涉及高级军官",
      what: "五角大楼对美军战略武器库存核心涉密数据外泄展开刑事调查，要求多名关键军官接受测谎。",
      when: "9月23日 08:54（军情核验播报）",
  ...
  },
  {
    ...
    summaryParagraph: "据9月23日 15:20司法通报，中国证监会原副主席王建军受贿案在青岛市中级人民法院一审公开宣判，认定受贿金额9340万元，依法判处无期徒刑。信源表明，该事项起因于依法惩治利用发行监管职权寻租腐败行为。直接影响方面，从制度层面压实保荐机构看门人责任。",
    summary5W1H: {
      who: "山东省青岛市中级人民法院与中国证监会原副主席王建军",
      what: "王建军因受贿9340万元一审被判处无期徒刑，剥夺政治权利终身并没收个人全部财产。",
      when: "9月23日 15:20（司法权威通报）",
  ...
  },
  {
    ...
    summaryParagraph: "据9月23日 09:22路透全球要闻报道，乌拉圭境内散养禽类发现高致病性禽流感，政府签署紧急法令宣布全境进入卫生紧急状态。信源表明，该事项起因于防范病毒向周边南美规模化农牧养殖带扩散。直接影响方面，引发部分区域性农产品临时封关检验。",
    summary5W1H: {
      who: "乌拉圭农牧渔业部、国家卫生防疫局及跨国海关检疫机构",
      what: "乌拉圭境内发现高致病性禽流感，政府签署法令宣布全国进入卫生紧急状态。",
      when: "9月23日 09:22（电讯直报）",
